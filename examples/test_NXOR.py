...
def default_args(**kwargs):
	...
	parser.add_argument("--message-size", default=8, type=int)
...
for graph_id in range(args.number_of_examples):
	...
	graphs_train.add_graph_node(graph_id, "Node 1", number_of_outgoing_edges, node_type_name="T1")
	graphs_train.add_graph_node(graph_id, "Node 2", number_of_outgoing_edges, node_type_name="T2")
...
for graph_id in range(args.number_of_examples):
	number_of_outgoing_edges = 1
	graphs_test.add_graph_node(graph_id, "Node 1", number_of_outgoing_edges, node_type_name="T1")
	graphs_test.add_graph_node(graph_id, "Node 2", number_of_outgoing_edges, node_type_name="T2")
