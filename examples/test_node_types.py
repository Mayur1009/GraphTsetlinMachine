...
for graph_id in range(args.number_of_examples):
	...
	graphs_train.add_graph_node(graph_id, "Node 1", number_of_outgoing_edges, "N1")
	graphs_train.add_graph_node(graph_id, "Node 2", number_of_outgoing_edges, "N2")
...
for graph_id in range(args.number_of_examples):
	number_of_outgoing_edges = 1
	graphs_test.add_graph_node(graph_id, "Node 1", number_of_outgoing_edges, "N1")
	graphs_test.add_graph_node(graph_id, "Node 2", number_of_outgoing_edges, "N2")
